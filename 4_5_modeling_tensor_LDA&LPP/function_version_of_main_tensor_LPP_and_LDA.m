function [ RMSE,right_num,pred_price ] = function_version_of_main_tensor_LPP_and_LDA( lambda,R,MaxIter,alpha,beta )
%用于寻求参数的循环函数
%   使用LDA和LPP的方法
...
dim_t3=4;
%% 构建张量流
[re_tensor_flow, tensor_flow] = con_tensor_flow(total_num,dim1,dim2,dim3,'outproduct','no');
%% 训练得到X1，X2，X3
num_class = 3;%分为几类
