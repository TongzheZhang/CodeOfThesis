...
nf = open(r'E:\study\master of TJU\0Subject research\code\Important\get_features\anotherrefer.txt','a')
if 0 < len(fileLists): 
    ...
    for fileName in fileLists:
        ...
        if content:#每行是一个元素
            fileFenci = [ x for x in jieba.cut(' '.join(content))]#得到所有词
