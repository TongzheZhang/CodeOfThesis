function [re_tensor_flow,tensor_flow] = con_tensor_flow_min1(total_len,dim1,dim2,dim3,conmethod,whenormlize)
%构建两个张量流
%   之后要加入用什么方法构建的选项，外积法，还是三棍法
%   conmethod是构建方法，可以选择threestick，或者默认的外积构建法
%% 载入特征
load('E:\study\master of TJU\0Subject research\code\Important\0_1_special_data\firm_features_min1.mat');
load('E:\study\master of TJU\0Subject research\code\Important\0_1_special_data\news_features_pca_min1.mat');%注意对公司提取的特征是经过PCA降维之后的结果
load('E:\study\master of TJU\0Subject research\code\Important\0_1_special_data\emo_features_min1.mat');
%% 归一化,归一化好像对张量回归不好
