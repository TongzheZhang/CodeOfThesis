...
'''读入新闻特征'''
news_features_dict = sio.loadmat(r'E:\study\master of TJU\0Subject research\code\Important\0_1_special_data\news_features_pca_min1')
news_list = news_features_dict['news_features'].tolist()
'''读入情感特征'''
emo_features_dict = sio.loadmat(r'E:\study\master of TJU\0Subject research\code\Important\0_1_special_data\emo_features_min1')
emotion_list = emo_features_dict['emo_features'].tolist()
'''读入情感特征'''
firm_features_dict = sio.loadmat(r'E:\study\master of TJU\0Subject research\code\Important\0_1_special_data\firm_features_min1')
firm_list = firm_features_dict['firm_features'].tolist()
'''读入y值'''
y_incre_dict = sio.loadmat(r'E:\study\master of TJU\0Subject research\code\Important\0_1_special_data\y_min1')
price_list = y_incre_dict['y_min1'].reshape(total_len).tolist()
...
'''KNN回归'''
uni_knr=KNeighborsRegressor(weights='distance',n_neighbors = 5)#uniform平均回归，distance是根据距离加权回归
...
'''输出预测文本，哪里需要，把这段代码粘哪'''
f = open(r'E:\study\master of TJU\0Subject research\code\Important\5_1_mock_trading\pred_result_min1.txt','w')
