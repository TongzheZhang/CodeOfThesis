...
def get_features_news_func():
    ...
    sio.savemat(r'E:\study\master of TJU\0Subject research\code\Important\0_1_special_data\news_features_min1.mat', {'news_features': totalftidf})

    '''得到合体的特征，并保存为mat文件'''
    totalpca = pca_X_train+pca_X_test
    sio.savemat(r'E:\study\master of TJU\0Subject research\code\Important\0_1_special_data\news_features_pca_min1.mat', {'news_features': totalpca})
    return totalpca
if __name__ == "__main__":

    totalpca = get_features_news_func()